...
@section('content')
    <div class="admin-content-body">
        ...
        <div class="am-cf am-padding am-padding-bottom-0">
            <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">新增文章分类</strong> / <small>Create Article Type</small></div>
        </div>
        <hr>

        <!--内容开始-->
        <div class="form-content">
            <form action="{{url('/article/createType')}}" method="post" class="am-form" data-am-validator>
             {{ csrf_field() }}
            <fieldset>
